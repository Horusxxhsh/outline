...
import { SparklesIcon, TableOfContentsIcon, EditIcon } from "outline-icons";
...
import DocumentReportDialog from "~/components/DocumentReportDialog";
    ...
    dialogs.openModal({
      ...
      content: (
        <DocumentReportDialog
          document={document}
          onRequestClose={dialogs.closeAllModals}
        />
      ),
    });
  }, [dialogs, document, t]);
    ...
    <StyledHeader
      ...
      actions={({ isCompact }) => (
        <>
          ...
          {!isEditing && !isRevision && !isDeleted && can.createReport && (
            <Action>
              <Tooltip content={t("Generate report")} placement="bottom">
                <Button
                  icon={<SparklesIcon />}
                  onClick={handleGenerateReport}
                  neutral
                >
                  {isCompact ? null : t("Generate")}
                </Button>
              </Tooltip>
            </Action>
          )}
